...
Polynomial tools
Bruce Wernick
06 November 2017 17:58:51
"""

__all__ = ['quad', 'cubic', 'polyMLR3', 'poly2DU', 'poly2D', 'polyARI',
...
def poly2D(xxx_todo_changeme, x, y):
  "Quadratic in 2D with cross-terms"
  (a,b,c,d,e,f,g,h,i) = xxx_todo_changeme
  return a + x*(b + x*c) + y*(d + y*e) + x*y*(f + x*g + y*h + x*y*i)

def polyARI(xxx_todo_changeme1, x, y):
  "ARI compressor polynomial"
  (a,b,c,d,e,f,g,h,i,j) = xxx_todo_changeme1
